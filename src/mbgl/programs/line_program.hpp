...
class LinePatternProgram final : public Program<LinePatternProgram,
...
class LineSDFProgram final : public Program<LineSDFProgram,
...
class LineGradientProgram final
    : public Program<
          LineGradientProgram,
