...
#include <mbgl/gl/custom_puck_shaders.hpp>
...
UniqueProgram createPuckShader(gl::Context& context) {
    auto vertexShader = context.createShader(gl::ShaderType::Vertex, {customPuckVertexShader});
    auto fragmentShader = context.createShader(gl::ShaderType::Fragment, {customPuckPixelShader});
