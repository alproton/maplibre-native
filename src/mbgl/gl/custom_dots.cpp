...
#include <mbgl/gl/custom_dots_shaders.hpp>
...
UniqueProgram createShader(gl::Context& context) {
    auto vertexShader = context.createShader(gl::ShaderType::Vertex, {customDotsVertexShader});
    auto fragmentShader = context.createShader(gl::ShaderType::Fragment, {customDotsPixelShader});
