...
void CustomDots::drawImpl() {
    ...
    glUniform2f(1, iconDx, iconDy);
    glUniform3f(2, options.innerColor.r, options.innerColor.g, options.innerColor.b);
    glUniform3f(3, options.outerColor.r, options.outerColor.g, options.outerColor.b);
    glUniform1f(4, innerFactor);
