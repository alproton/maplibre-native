...
class PUCKView : public mbgl::MapObserver {
public:
    PUCKView(bool fullscreen,
             bool benchmark,
    ...
    void setRenderFrontend(PUCKRendererFrontend *);
    ...
    PUCKRendererFrontend *getRenderFrontend() const;
...
private:
    ...
    PUCKRendererFrontend *rendererFrontend = nullptr;
