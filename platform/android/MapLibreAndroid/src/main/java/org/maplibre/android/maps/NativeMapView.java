...
final class NativeMapView implements NativeMap {
  ...
  public void setCustomDotsPoints(MultiPoint points) {
    nativeSetCustomDotsPoints(points);
  }
  ...
  public void setCustomDotsOptions(CustomDotsOptions options) {
    nativeSetCustomDotsOptions(options.nextLayer,
  ...
  @Keep
  private native void nativeRoutesBegineCapture();
  ...
  //---------------------Custom Dots APIs---------------------
  @Keep
  private native void nativeSetCustomDotsPoints(MultiPoint points);

  @Keep
  private native void nativeClearCustomDotsVideoMemory();

  @Keep
  private native void nativeSetCustomDotsOptions(String nextLayer,
                                                 float innerR,
                                                 float innerG,
                                                 float innerB,
                                                 float outerR,
